        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    normalized_number = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_prospects_users_assigned_to_user_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    whatsapp_media_url = table.Column<string>(type: "text", nullable: true),
                    whatsapp_message_id = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "ix_messages_prospect_id_created_at",
                table: "messages",
                columns: new[] { "prospect_id", "created_at" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_phones_normalized_number",
                table: "phones",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_prospects_assigned_to_user_id",
                table: "prospects",
